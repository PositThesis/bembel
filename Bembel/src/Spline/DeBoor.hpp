...
Eigen::Matrix<T, -1, -1>
DeBoor(Eigen::Matrix<T, -1, -1> const &control_points,
       const std::vector<ptScalar> &knot_vector,
...
DeBoor(std::vector<Eigen::Matrix<T, -1, -1>> const &control_points,
       std::vector<ptScalar> const &knot_vector,
