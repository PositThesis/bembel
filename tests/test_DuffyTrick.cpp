...
int main() {
  ...
  Bembel::AnsatzSpace<Bembel::DummyOperator<double>, double> ansatz_space(
      geometry, Test::Constants::DuffyTrick_refinement_level, 0);
  // test integrate0
  {
    Bembel::DummyOperator<double> Op0(Test::DuffyTrick::integrate0_test_function);
    bool test0 = Test::DuffyTrick::test_integrate0<
        Bembel::DummyOperator<double>, Test::Constants::DuffyTrick_quadrature_degree>(
        ansatz_space, Op0);
    BEMBEL_TEST_IF(test0);
  }
  // test integrate1
  {
    Bembel::DummyOperator<double> Op1(Test::DuffyTrick::integrate1_test_function);
  ...
  // test integrate2
  {
    Bembel::DummyOperator<double> Op2(Test::DuffyTrick::integrate2_test_function);
  ...
  // test integrate3
  {
    Bembel::DummyOperator<double> Op3(Test::DuffyTrick::integrate3_test_function);
  ...
  // test integrate4
  {
    Bembel::DummyOperator<double> Op4(Test::DuffyTrick::integrate4_test_function);
