...
int main() {
  ...
  std::vector<MatrixXd> fmm_moment_matrix1 =
      H2Multipole::Moment2D<H2Multipole::ChebychevRoots<double>, DummyOperator<double>, double>::
  ...
  std::vector<MatrixXd> fmm_moment_matrix2 = H2Multipole::
      Moment2D<H2Multipole::ChebychevRoots<double>, DummyOperator<double>, double>::compute2DMoment(
